...
@Autowired
    ...
    public RestfulDTO<Object> pageKohinProductByKohinInventoryProductId(@RequestBody KohinInventoryProductDTO kohinInventoryProductDTO) {
        Page<KohinInventoryProductDTO> page = new Page<>(kohinInventoryProductDTO.getCurrentPage(), kohinInventoryProductDTO.getPageSize());
        IPage<KohinInventoryProductVO>kohinInventoryProductVOIPage= kohinInventoryProductService.pageKohinProductByKohinInventoryProductId(page, kohinInventoryProductDTO.getKohinInventoryProductId());
        return HttpResponseUtil.data(kohinInventoryProductVOIPage);
                //kohinInventoryProductService.pageKohinProductByKohinInventoryProductId(new Page<>(kohinInventoryProductDTO.getCurrentPage(), kohinInventoryProductDTO.getPageSize()), kohinInventoryProductDTO.getKohinInventoryProductId()));
    }
}
